...
In the last [section](05_shiny_basics.html) we set up the basic skeloton of a Shiny Application. In this section wwe ill demonstrate how to add your leaflet `basemap` to the Shiny `ui` and how `observeEvent` can be used to record how the mouse cursor interacts with the `leaflet` map.
