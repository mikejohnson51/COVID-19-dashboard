...
If you do not have R and R studio already installed you can find R [here](https://www.r-project.org/). Make sure to get the most up to date version that is not a "pre-release".
...
Follow the directions for installing each of those and you a will be set to go! Remeber though, that since RStudio runs R, you must install R first `r emo::ji("smile")`
...
Alternatively you can run a linea one-by-one using the same keyboard shortcuts, or the `RUN` icon in the top right of the text editing window.
