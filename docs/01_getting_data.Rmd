...
This section is all about getting data for visualization. You will stream COVID data from the NYTimes and join the most current data county centroids.
...
Fantastic, now we have methods and data needed to build our Shiny App. Lets move to the next [section](02_dynamic_plots.html) where we will make interactive maps and charts with this data.